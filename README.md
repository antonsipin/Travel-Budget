...
<h3>
Technologies used: HTML, CSS, JavaScript, MongoDB Cluster, Handlebars, Mongoose, Express, Node.js, Material-UI, Nodemailer, REST API. 
</h3>
...
<h3 align="center">
  ...
  <img src="public/1.gif" width="700" title="Authentication"><br />
  <p>Adding a trip:</p><br />
  
  <img src="public/2.gif" width="700" title="Adding a trip"><br />
  <p>Adding an expense category:</p><br />
  
  <img src="public/3.gif" width="700" title="Adding an expense category"><br />
